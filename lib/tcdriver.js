...
(function() {
  ...
  module.exports = tcdriver = (function(superClass) {
    ...
    function tcdriver(paramObj, tool) {
      ...
      atr = exec('cscript ' + getParent(__dirname) + '\\Utilities\\atr.js ' + this.testtool + ' "' + this.projectSuite + '" /p:"' + this.project + '" /s:"' + this.fullmethodname + '" /silentmode', (function(_this) {
    ...
    getParent = function(path) {
      ...
      return path.substring(0, parentId);
    };
